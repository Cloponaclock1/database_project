...
addRowToTable = (data) => {
    ...
    idCell.innerText = newRow.employeesID;
    NameCell.innerText = newRow.employeesName;
    
    deleteCell = document.createElement("button");
    deleteCell.innerHTML = "Delete";
    deleteCell.onclick = function(){
        deleteEmployee(newRow.employeesID);
    };
    ...
    row.setAttribute('data-value', newRow.employeesID);
    ...
    option.text = newRow.employeesName;
